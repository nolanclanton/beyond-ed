 ...
 * the STANDARDS each phase connects to are real codes taken from the generated
 * catalog's Integrated Math 1 alignment matrix, so the connection back to the
 * pathway is genuine even though the storyline is not adopted curriculum.
 *
...
export type SequencePhase = {
  ...
  brief: string;
  /** Real standard codes from the Integrated Math 1 alignment matrix. */
  standards: string[];
      ...
      phases: [
        {
          ...
          standards: ["A-CED.1 [CA,*]"],
          linkedLessonCode: "IM1-U3-L1",
          minutes: 15,
        },
        {
          id: "fw-7",
